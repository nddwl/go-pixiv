...
//ProfileIllusts https://www.pixiv.net/ajax/user/<user_id>/profile/illusts?ids[]=<illust_id>&lang=<lang>&version=<version>
type ProfileIllusts struct {
	Error   bool   `json:"error"`
	Message string `json:"message"`
	Body    struct {
		Works      utils.Illust `json:"works"`
		ZoneConfig struct {
			Header struct {
